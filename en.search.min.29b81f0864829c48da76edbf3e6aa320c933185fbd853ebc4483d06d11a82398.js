...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-database/flexsearch.min.js');loadScript('/study-database/en.search-data.min.66c167d04f5c95caa6211ff1220acff370088e0ff2b24e3e405b7b5a7ee0ea4a.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-database/flexsearch.min.js');loadScript('/study-database/en.search-data.min.dceb486784686a725cac734130be7fa886f440898d9bebac753521a6b096803b.js',function(){input.required=false;search();});}
